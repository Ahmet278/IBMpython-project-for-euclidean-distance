# IBMpython-project-for-euclidean-distance
Bu proje IBM kapsamında yapılan eğitim-bootcamp içeriği dahilinde yapılması istenen projelerden biridir. 
Euclidean distance, yani öklid uzaydaki mesafe hesaplama formülünü kullanan ve minimum mesafeyi hesaplayan kod yazımı. Ayrıca bu programda noktalar kullanıcı tarafından girilmektedir.
